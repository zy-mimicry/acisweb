...
def show_time_jenkins_test_01(platform):
    ...
    out['PLATFORM'] = platform
    out['ERD_ID'] = ""
    out['description'] = "Integration Test"
    out['jenkins'] = {
        'IR_casetree' : {
...
def show_time_jenkins_test_02(platform):
    ...
    out['PLATFORM'] = platform
    out['ERD_ID'] = ""
    out['description'] = 'customized test'
    out['jenkins'] = {
        'IR_casetree' : {
            "test_case_01_alpha_01" : {
...
def show_time_jenkins_test_04(platform):
    ...
    out['PLATFORM'] = platform
    out['ERD_ID'] = ""
    out['description'] = "Regression Test"
    out['jenkins'] = {
        'IR_casetree' : {
            "test_case_01_alpha_01" : {
